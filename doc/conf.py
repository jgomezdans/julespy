# -*- coding: utf-8 -*-
#
# JULESpy documentation build configuration file, created by
...
project = u'JULESpy'
copyright = u'2010, Jose Gomez-Dans and Martin de Kauwe'
